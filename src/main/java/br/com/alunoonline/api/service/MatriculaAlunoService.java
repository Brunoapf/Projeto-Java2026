...
public class MatriculaAlunoService {
    ...
    public void atualizarNotas(Long id, AtualizarNotasRequestDTO dto) {
        ...
        MatriculaAluno matricula =
                matriculaAlunoRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Matricula não encontrada"));
        ...
        if (matricula.getNota1() != null && matricula.getNota2() != null) {
            ...
            matricula.setStatus(media >= MEDIA_PARA_APROVACAO ? MatriculaAlunoStatusEnum.APROVADO : MatriculaAlunoStatusEnum.REPROVADO);
        }
    ...
    public void trancarMatricula(Long id){
        ...
        if (matriculaAluno.getStatus()
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"So é possivel trancar com o status MATRICULADO ");
        }
    }
}
